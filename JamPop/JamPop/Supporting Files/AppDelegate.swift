...
//            masterViewController.dataController = self.dataController
//
//        }
    ...
    // <-- applicationDocumentsDirectory from simpleCam
    ...
    // <-- managedObjectModel from simpleCam
    lazy var managedObjectModel: NSManagedObjectModel = {
        // The managed object model for the application. This property is not optional. It is a fatal error for the application not to be able to find and load its model.
        let modelURL = Bundle.main.url(forResource: "JamPopModel", withExtension: "momd")!
        return NSManagedObjectModel(contentsOf: modelURL)!
    }()
    // End -->
    
    // <-- persistentStoreCoordinator from simpleCam
    ...
    // <-- managedObjectContext from simpleCam
...
//         */
//        let container = NSPersistentContainer(name: "JamPopModel")
